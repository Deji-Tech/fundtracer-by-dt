  ...
  return (
    ...
    >
      ...
      <div className="intel-page">
        ...
        <section className="intel-featured">
          <div className="intel-featured__label">Featured In</div>
          <div className="intel-featured__grid">
            <a href="https://alchemy.com" target="_blank" rel="noopener" className="intel-featured__item" data-logo="alchemy">
              <div className="intel-featured__icon">
                <svg viewBox="0 0 24 24" fill="currentColor">
                  <path d="M12 2L2 7l10 5 10-5-10-5zM2 17l10 5 10-5M2 12l10 5 10-5"/>
                </svg>
              </div>
              <span className="intel-featured__name">Alchemy</span>
            </a>
            <a href="https://linea.build" target="_blank" rel="noopener" className="intel-featured__item" data-logo="linea">
              <div className="intel-featured__icon">
                <svg viewBox="0 0 24 24" fill="currentColor">
                  <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-1 17.93c-3.95-.49-7-3.85-7-7.93 0-.62.08-1.21.21-1.79L9 15v1c0 1.1.9 2 2 2v1.93zm6.9-2.54c-.26-.81-1-1.39-1.9-1.39h-1v-3c0-.55-.45-1-1-1H8v-2h2c.55 0 1-.45 1-1V7h2c1.1 0 2-.9 2-2v-.41c2.93 1.19 5 4.06 5 7.41 0 2.08-.8 3.97-2.1 5.39z"/>
                </svg>
              </div>
              <span className="intel-featured__name">Linea</span>
            </a>
            <a href="https://sui.io" target="_blank" rel="noopener" className="intel-featured__item" data-logo="sui">
              <div className="intel-featured__icon">
                <svg viewBox="0 0 24 24" fill="currentColor">
                  <path d="M12 2L4 6l8 4 8-4-8-4zM4 14l8 4 8-4M4 18l8 4 8-4"/>
                </svg>
              </div>
              <span className="intel-featured__name">Sui</span>
            </a>
            <a href="https://arbitrum.io" target="_blank" rel="noopener" className="intel-featured__item" data-logo="arbitrum">
              <div className="intel-featured__icon">
                <svg viewBox="0 0 24 24" fill="currentColor">
                  <circle cx="12" cy="12" r="10"/>
                  <circle cx="12" cy="12" r="4" fill="var(--intel-bg-surface)"/>
                </svg>
              </div>
              <span className="intel-featured__name">Arbitrum</span>
            </a>
            <a href="https://ethereum.org" target="_blank" rel="noopener" className="intel-featured__item" data-logo="ethereum">
              <div className="intel-featured__icon">
                <svg viewBox="0 0 24 24" fill="currentColor">
                  <path d="M12 1.5l-8 9v6h5v-3.5h6V16.5h5v-6l-8-9zm0 4.5l3.5 4v2.5h-2.5v-2.5L12 6z"/>
                </svg>
              </div>
              <span className="intel-featured__name">Ethereum</span>
            </a>
            <a href="https://base.org" target="_blank" rel="noopener" className="intel-featured__item" data-logo="base">
              <div className="intel-featured__icon">
                <svg viewBox="0 0 24 24" fill="currentColor">
                  <circle cx="12" cy="12" r="10"/>
              ...
              <span className="intel-featured__name">Base</span>
            </a>
            <a href="https://polygon.technology" target="_blank" rel="noopener" className="intel-featured__item" data-logo="polygon">
              <div className="intel-featured__icon">
                <svg viewBox="0 0 24 24" fill="currentColor">
                  <path d="M12 2l8 4v8l-8 4-8-4V6l8-4zm0 2.5L6.5 7.5 12 6l5.5 1.5L12 4.5zM4 12l4.5.5L12 11l3.5 1.5L20 12l-4.5.5L12 14l-3.5-1.5L4 12zm0 2l3.5 1.5L12 14l4.5-.5L20 12l-3.5 1.5L12 17 8.5 15.5 4 14z"/>
                </svg>
              </div>
              <span className="intel-featured__name">Polygon</span>
            </a>
            <a href="https://optimism.io" target="_blank" rel="noopener" className="intel-featured__item" data-logo="optimism">
              <div className="intel-featured__icon">
                <svg viewBox="0 0 24 24" fill="currentColor">
                  <path d="M12 2l10 5v5l-10 5-10-5V7l10-5z"/>
                </svg>
              </div>
              <span className="intel-featured__name">Optimism</span>
            </a>
          </div>
        </section>
