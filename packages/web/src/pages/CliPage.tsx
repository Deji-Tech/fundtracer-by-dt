  ...
  return (
    ...
    <div className="cli-page">
      <div className="cli-container">
        ...
        >
          <h2>Connect CLI to Your Account</h2>
          <p>Link your CLI to earn rewards and sync your scan history.</p>
          ...
          {isAuthenticated && profile ? (
            ...
            <div className="cli-link-section">
              ...
              >
                ...
                {linkLoading ? 'Connecting...' : 'Sign in with Google'}
              </button>
              <p className="cli-link-note">
                Sign in to link your CLI and earn rewards
              </p>
            </div>
          )}
        </motion.div>
