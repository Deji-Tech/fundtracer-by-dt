...
const WALLET_IDS = {
    ...
    COINBASE: 'fd20dc426fb37566d803205b19bbc1d4096b248ac04548e18e93c30de2ce23c4',
...
// All wallets that can connect (CRITICAL for mobile support)
...
export function initializeAppKit() {
    ...
    try {
        appKitInstance = createAppKit({
            ...
            // Wallet display configuration - CRITICAL for mobile
            featuredWalletIds,
            includeWalletIds,
