...
// Create metadata object with dynamic URLs based on current origin
const getMetadata = () => ({
    name: 'FundTracer',
...
// AppKit instance - will be created by calling createAppKit
export let appKit: ReturnType<typeof createAppKit> | null = null

// Initialize AppKit - call this BEFORE any components render
