            ...
            {profile?.tier === 'free' && showPricing && (
                <div style={{
                    ...
                    <p style={{
                        ...
                        Unlock unlimited analysis and skip gas fees on every request!
                    </p>
                    ...
                    <div style={{
                        ...
                        <div style={{
                            ...
                            <div style={{ fontSize: 'var(--text-lg)', fontWeight: 700, color: '#9333EA' }}>
                                20 USDT
                            </div>
                            <div style={{ fontSize: 'var(--text-xs)', color: 'var(--color-text-secondary)' }}>
                                30 days • Premium perks
                            </div>
                        </div>
                    </div>
                    ...
                    <div style={{
                        ...
                        <strong style={{ color: '#10B981' }}>Payment Address (Linea USDT):</strong>
                        <div style={{
                            ...
                            0xFF1A1D11CB6bad91C6d9250082D1DF44d84e4b87
                        </div>
                        <div style={{ marginTop: 'var(--space-2)', fontSize: '10px', fontStyle: 'italic' }}>
                            Send USDT on Linea Mainnet to this address. Your tier upgrades automatically within 2 minutes.
                        </div>
                    </div>
                </div>
            )}
