...
export const ArrowSwapIcon: React.FC<IconProps> = ({ className, size = 20 }) => (
  <svg 
    className={className} 
    width={size} 
    height={size} 
...
export const PositionIcon: React.FC<IconProps> = ({ className, size = 20 }) => (
  <svg 
    className={className} 
    width={size} 
    height={size} 
...
export const RadarEmptyIcon: React.FC<IconProps> = ({ className, size = 80 }) => (
  <svg 
    className={className} 
    width={size} 
    height={size} 
    ...
    strokeWidth="1.5"
  >
    <circle cx="40" cy="40" r="30" strokeDasharray="4 4" opacity="0.3" />
    <circle cx="40" cy="40" r="20" strokeDasharray="2 2" opacity="0.5" />
    <circle cx="40" cy="40" r="8" opacity="0.4" />
    <line x1="40" y1="10" x2="40" y2="18" opacity="0.3" />
    <line x1="40" y1="62" x2="40" y2="70" opacity="0.3" />
    <line x1="10" y1="40" x2="18" y2="40" opacity="0.3" />
    <line x1="62" y1="40" x2="70" y2="40" opacity="0.3" />
  </svg>
);
