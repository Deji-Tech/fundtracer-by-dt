import{ct as n,st as p,ut as g}from"./vendor-ZFsBW_sc.js";import{n as d,r,t as M}from"./lit-element-Duw9y9rq.js";var u=Object.defineProperty,w=Object.getOwnPropertyDescriptor,s=(a,o,h,i)=>{for(var e=i>1?void 0:i?w(o,h):o,c=a.length-1,l;c>=0;c--)(l=a[c])&&(e=(i?l(o,h,e):l(e))||e);return i&&e&&u(o,h,e),e},t=class extends M{constructor(){super(...arguments),this.size="1em",this.weight="regular",this.color="currentColor",this.mirrored=!1}render(){var a;return d`<svg
  ...
  `;s([p({type:String,reflect:!0})],t.prototype,"size",2);s([p({type:String,reflect:!0})],t.prototype,"weight",2);s([p({type:String,reflect:!0})],t.prototype,"color",2);s([p({type:Boolean,reflect:!0})],t.prototype,"mirrored",2);t=s([n("ph-user")],t);export{t as PhUser};
