import{ct as g,st as i,ut as d}from"./vendor-J89_OWP8.js";import{n as c,r,t as w}from"./lit-element-D8HVZO93.js";var u=Object.defineProperty,y=Object.getOwnPropertyDescriptor,o=(a,l,p,s)=>{for(var e=s>1?void 0:s?y(l,p):l,h=a.length-1,n;h>=0;h--)(n=a[h])&&(e=(s?n(l,p,e):n(e))||e);return s&&e&&u(l,p,e),e},t=class extends w{constructor(){super(...arguments),this.size="1em",this.weight="regular",this.color="currentColor",this.mirrored=!1}render(){var a;return c`<svg
  ...
  `;o([i({type:String,reflect:!0})],t.prototype,"size",2);o([i({type:String,reflect:!0})],t.prototype,"weight",2);o([i({type:String,reflect:!0})],t.prototype,"color",2);o([i({type:Boolean,reflect:!0})],t.prototype,"mirrored",2);t=o([g("ph-arrow-down")],t);export{t as PhArrowDown};
