import{o as w}from"./rolldown-runtime-MddlTo9B.js";import{Ar as A,Dn as k,Er as P,Hn as S,On as F,Or as r,Pr as s,Sr as x,Wn as B,gr as T,lr as E,ou as O,qr as I,xu as D}from"./vendor-PMpPQw2V.js";import{t as j}from"./proxy-Bbp7pKkD.js";import{t as R}from"./AnimatePresence-MOlCFjyM.js";import{t as q}from"./LandingLayout-bBC9H9cK.js";var c=w(D(),1),e=O(),Y=[{label:"About",href:"/about"},{label:"Features",href:"/features"},{label:"Pricing",href:"/pricing"},{label:"How It Works",href:"/how-it-works"},{label:"FAQ",href:"/faq"},{label:"API",href:"/api-docs",active:!0},{label:"CLI",href:"/cli"}];function M(){const[i,u]=(0,c.useState)(null),[l,g]=(0,c.useState)("overview"),[C,p]=(0,c.useState)(!1),[y,f]=(0,c.useState)(!1),[z,b]=(0,c.useState)(!1),[N,h]=(0,c.useState)(""),[t,v]=(0,c.useState)({name:"",company:"",email:"",message:""}),[K,L]=(0,c.useState)(!1),m=a=>{v(o=>({...o,[a.target.name]:a.target.value})),h("")},_=async a=>{if(a.preventDefault(),!t.name||!t.email||!t.message){h("Please fill in all required fields");return}f(!0),h("");try{const o=await(await fetch("/api/contact/sales",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(t)})).json();o.success?(b(!0),v({name:"",company:"",email:"",message:""})):h(o.error||"Failed to send message")}catch{h("Failed to send message. Please try again.")}finally{f(!1)}},n=(a,o)=>{navigator.clipboard.writeText(a),u(o),setTimeout(()=>u(null),2e3)},d={wallet:{curl:`curl -X POST "https://api.fundtracer.xyz/api/analyze/wallet" \\
