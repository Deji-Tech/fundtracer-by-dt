import{o as c}from"./rolldown-runtime-MddlTo9B.js";import{mc as d,wc as u,xc as h}from"./vendor-3fpDGbiB.js";import{s as m}from"./primitives-C1ZCxPBj.js";import{t as s}from"./LandingLayout-FQBKUUsu.js";var p=c(u(),1),e=d(),o=[{label:"Intel",href:"/"},{label:"Blog",href:"/blog",active:!0},{label:"Docs",href:"/docs/getting-started"},{label:"Features",href:"/features"},{label:"Pricing",href:"/pricing"},{label:"How It Works",href:"/how-it-works"},{label:"FAQ",href:"/faq"},{label:"API",href:"/api-docs"},{label:"CLI",href:"/cli"},{label:"About",href:"/about"}],g={"fundtracer-v2-leaderboard-rebuilt":{id:"0",title:"FundTracer v2: The Leaderboard That Actually Works",excerpt:"We rebuilt our rewards system from scratch. See how we achieved 98% Firestore read reduction and built a leaderboard that scales.",category:"Engineering",date:"2026-04-22",readTime:"5 min read",author:"FundTracer Team",slug:"fundtracer-v2-leaderboard-rebuilt",content:`
...
For more on this topic, see our articles on What is Sybil Detection and How Airdrop Farmers Get Caught.
    `}};function v(){const t=g[h().pathname.split("/").pop()||""];if((0,p.useEffect)(()=>{if(t){document.title=`${t.title} | FundTracer Blog`;const a=document.createElement("script");return a.type="application/ld+json",a.textContent=JSON.stringify({"@context":"https://schema.org","@type":"Article",headline:t.title,description:t.excerpt,author:{"@type":"Organization",name:t.author},datePublished:t.date,readTime:t.readTime,url:`https://www.fundtracer.xyz/blog/${t.slug}`}),document.head.appendChild(a),()=>{document.head.removeChild(a)}}},[t]),!t)return(0,e.jsx)(s,{navItems:o,showSearch:!1,children:(0,e.jsxs)("div",{className:"blog-post-error",children:[(0,e.jsx)("h1",{children:"Post Not Found"}),(0,e.jsx)("p",{children:"The blog post you're looking for doesn't exist."}),(0,e.jsx)("a",{href:"/blog",children:"Back to Blog"})]})});const l=t.content.split(`
...
`).filter(n=>/^\d+\./.test(n)).map((n,r)=>(0,e.jsx)("li",{children:n.replace(/^\d+\.\s*/,"")},r))},i):(0,e.jsx)("p",{children:a},i))}),(0,e.jsx)("footer",{className:"blog-post__footer",children:(0,e.jsx)("a",{href:"/blog",className:"blog-post__back",children:"Back to Blog"})})]})})}export{v as BlogPostPage,v as default};
