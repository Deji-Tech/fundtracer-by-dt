import{in as g,on as d,rn as l}from"./vendor-DHU1kG0o.js";import{n as c,r as e,t as f}from"./lit-element-DBDtvLpp.js";var u=Object.defineProperty,w=Object.getOwnPropertyDescriptor,o=(a,s,p,i)=>{for(var r=i>1?void 0:i?w(s,p):s,h=a.length-1,n;h>=0;h--)(n=a[h])&&(r=(i?n(s,p,r):n(r))||r);return i&&r&&u(s,p,r),r},t=class extends f{constructor(){super(...arguments),this.size="1em",this.weight="regular",this.color="currentColor",this.mirrored=!1}render(){var a;return c`<svg
  ...
  `;o([l({type:String,reflect:!0})],t.prototype,"size",2);o([l({type:String,reflect:!0})],t.prototype,"weight",2);o([l({type:String,reflect:!0})],t.prototype,"color",2);o([l({type:Boolean,reflect:!0})],t.prototype,"mirrored",2);t=o([g("ph-caret-left")],t);export{t as PhCaretLeft};
