import{o as w}from"./rolldown-runtime-MddlTo9B.js";import{Bn as A,Dn as k,Er as s,On as P,Rn as S,Rr as F,Sr as B,Zl as T,br as r,fu as E,mr as x,rr as I,ur as O,vr as R}from"./vendor-BcddyAvY.js";import{t as j}from"./proxy-Ck-2jV1x.js";import{t as D}from"./AnimatePresence-OMIa0xXP.js";import{t as Y}from"./LandingLayout-CsXQ8kgn.js";var c=w(E(),1),e=T(),q=[{label:"About",href:"/about"},{label:"Features",href:"/features"},{label:"Pricing",href:"/pricing"},{label:"How It Works",href:"/how-it-works"},{label:"FAQ",href:"/faq"},{label:"API",href:"/api-docs",active:!0},{label:"CLI",href:"/cli"}];function W(){const[i,u]=(0,c.useState)(null),[l,g]=(0,c.useState)("overview"),[C,p]=(0,c.useState)(!1),[y,f]=(0,c.useState)(!1),[z,b]=(0,c.useState)(!1),[N,h]=(0,c.useState)(""),[t,v]=(0,c.useState)({name:"",company:"",email:"",message:""}),[K,L]=(0,c.useState)(!1),m=a=>{v(o=>({...o,[a.target.name]:a.target.value})),h("")},_=async a=>{if(a.preventDefault(),!t.name||!t.email||!t.message){h("Please fill in all required fields");return}f(!0),h("");try{const o=await(await fetch("/api/contact/sales",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(t)})).json();o.success?(b(!0),v({name:"",company:"",email:"",message:""})):h(o.error||"Failed to send message")}catch{h("Failed to send message. Please try again.")}finally{f(!1)}},n=(a,o)=>{navigator.clipboard.writeText(a),u(o),setTimeout(()=>u(null),2e3)},d={wallet:{curl:`curl -X POST "https://api.fundtracer.xyz/api/analyze/wallet" \\
