import{ct as g,st as i,ut as c}from"./vendor-3fpDGbiB.js";import{n as d,r,t as w}from"./lit-element-vGwn5uA9.js";var u=Object.defineProperty,y=Object.getOwnPropertyDescriptor,l=(a,o,p,s)=>{for(var e=s>1?void 0:s?y(o,p):o,h=a.length-1,n;h>=0;h--)(n=a[h])&&(e=(s?n(o,p,e):n(e))||e);return s&&e&&u(o,p,e),e},t=class extends w{constructor(){super(...arguments),this.size="1em",this.weight="regular",this.color="currentColor",this.mirrored=!1}render(){var a;return d`<svg
  ...
  `;l([i({type:String,reflect:!0})],t.prototype,"size",2);l([i({type:String,reflect:!0})],t.prototype,"weight",2);l([i({type:String,reflect:!0})],t.prototype,"color",2);l([i({type:Boolean,reflect:!0})],t.prototype,"mirrored",2);t=l([g("ph-caret-down")],t);export{t as PhCaretDown};
