import{in as c,on as g,rn as p}from"./vendor-DHU1kG0o.js";import{n as d,r,t as M}from"./lit-element-DBDtvLpp.js";var u=Object.defineProperty,w=Object.getOwnPropertyDescriptor,s=(a,o,h,i)=>{for(var e=i>1?void 0:i?w(o,h):o,n=a.length-1,l;n>=0;n--)(l=a[n])&&(e=(i?l(o,h,e):l(e))||e);return i&&e&&u(o,h,e),e},t=class extends M{constructor(){super(...arguments),this.size="1em",this.weight="regular",this.color="currentColor",this.mirrored=!1}render(){var a;return d`<svg
  ...
  `;s([p({type:String,reflect:!0})],t.prototype,"size",2);s([p({type:String,reflect:!0})],t.prototype,"weight",2);s([p({type:String,reflect:!0})],t.prototype,"color",2);s([p({type:Boolean,reflect:!0})],t.prototype,"mirrored",2);t=s([c("ph-user")],t);export{t as PhUser};
