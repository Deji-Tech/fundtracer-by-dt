import{o as b}from"./rolldown-runtime-MddlTo9B.js";import{$n as f,Dn as d,Gl as g,Ln as v,Sr as N,_r as A,ar as C,dr as T,fr as k,hr as P,jr as c,kr as l,or as R,ou as E,pr as o,vr as h,wr as I,xr as w}from"./vendor-BfkTOvcn.js";import{t as n}from"./proxy-DBLy8aTB.js";import{t as _}from"./LandingLayout-gtnZdBWG.js";var x=b(E(),1),e=g(),z=[{label:"About",href:"/about"},{label:"Features",href:"/features"},{label:"Pricing",href:"/pricing"},{label:"How It Works",href:"/how-it-works"},{label:"FAQ",href:"/faq"},{label:"API",href:"/api-docs"},{label:"CLI",href:"/cli"}];function q(){const[m,r]=(0,x.useState)(null),[a,p]=(0,x.useState)("introduction"),j=(i,t)=>{navigator.clipboard.writeText(i),r(t),setTimeout(()=>r(null),2e3)},u=()=>{navigator.clipboard.writeText(`# FundTracer API Documentation
