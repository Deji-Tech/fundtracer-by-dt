import{o as b}from"./rolldown-runtime-MddlTo9B.js";import{Dt as f,Sn as g,Yt as v,bn as N,dn as c,gn as l,hn as A,in as C,jn as o,kn as h,ln as T,mc as k,mt as d,nn as P,pn as R,un as E,wc as I,yn as w}from"./vendor-3fpDGbiB.js";import{t as n}from"./proxy-D88Wry_G.js";import{t as _}from"./LandingLayout-FQBKUUsu.js";var x=b(I(),1),e=k(),z=[{label:"About",href:"/about"},{label:"Features",href:"/features"},{label:"Pricing",href:"/pricing"},{label:"How It Works",href:"/how-it-works"},{label:"FAQ",href:"/faq"},{label:"API",href:"/api-docs"},{label:"CLI",href:"/cli"}];function q(){const[m,r]=(0,x.useState)(null),[a,p]=(0,x.useState)("introduction"),j=(i,t)=>{navigator.clipboard.writeText(i),r(t),setTimeout(()=>r(null),2e3)},u=()=>{navigator.clipboard.writeText(`# FundTracer API Documentation
...
print(data['result'])`,"python-example")]}),(0,e.jsx)("h3",{children:"cURL"}),(0,e.jsxs)("div",{className:"api-code-block",children:[(0,e.jsx)("pre",{children:(0,e.jsx)("code",{children:`curl -X POST "https://api.fundtracer.xyz/api/analyze/wallet" \\
  ...
  -H "Content-Type: application/json" \\
  -H "Authorization: Bearer ft_live_YOUR_API_KEY" \\
  -d '{"address": "0x742d35Cc6634C0532925a3b844Bc9e7595f5b2a1", "chain": "ethereum"}'`,"curl-example")]})]}),(0,e.jsxs)("div",{className:"docs-cta",children:[(0,e.jsx)("h3",{children:"Ready to Start?"}),(0,e.jsx)("p",{children:"Get your API key and start building in minutes."}),(0,e.jsxs)("a",{href:"/api/keys",className:"cta-btn",children:["Get API Key",(0,e.jsx)(h,{size:18})]})]})]})]})]})})})}export{q as ApiDocsPage,q as default};
