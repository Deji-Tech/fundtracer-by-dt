import{o as A}from"./rolldown-runtime-MddlTo9B.js";import{An as w,Dt as k,Sc as S,an as x,cn as P,en as F,fc as T,fn as B,gn as s,ht as E,kt as I,mt as O,qt as D,un as t}from"./vendor-D_xBkKtE.js";import{t as j}from"./proxy-BKJiN5xa.js";import{t as R}from"./AnimatePresence-CVrijo-h.js";import{t as Y}from"./LandingLayout-CPh1ev4t.js";import{t as q}from"./navigation-ITqPXr4N.js";var c=A(S(),1),e=T(),K=q.map(i=>i.href==="/api-docs"?{...i,active:!0}:i);function V(){const[i,u]=(0,c.useState)(null),[l,g]=(0,c.useState)("overview"),[C,p]=(0,c.useState)(!1),[y,f]=(0,c.useState)(!1),[z,N]=(0,c.useState)(!1),[b,h]=(0,c.useState)(""),[r,v]=(0,c.useState)({name:"",company:"",email:"",message:""}),[L,U]=(0,c.useState)(!1),m=a=>{v(o=>({...o,[a.target.name]:a.target.value})),h("")},_=async a=>{if(a.preventDefault(),!r.name||!r.email||!r.message){h("Please fill in all required fields");return}f(!0),h("");try{const o=await(await fetch("/api/contact/sales",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(r)})).json();o.success?(N(!0),v({name:"",company:"",email:"",message:""})):h(o.error||"Failed to send message")}catch{h("Failed to send message. Please try again.")}finally{f(!1)}},n=(a,o)=>{navigator.clipboard.writeText(a),u(o),setTimeout(()=>u(null),2e3)},d={wallet:{curl:`curl -X POST "https://api.fundtracer.xyz/api/analyze/wallet" \\
