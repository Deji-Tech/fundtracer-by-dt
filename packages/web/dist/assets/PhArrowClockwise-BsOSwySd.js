import{ct as c,st as l,ut as g}from"./vendor-3fpDGbiB.js";import{n as d,r,t as w}from"./lit-element-vGwn5uA9.js";var A=Object.defineProperty,v=Object.getOwnPropertyDescriptor,o=(a,s,i,h)=>{for(var e=h>1?void 0:h?v(s,i):s,p=a.length-1,n;p>=0;p--)(n=a[p])&&(e=(h?n(s,i,e):n(e))||e);return h&&e&&A(s,i,e),e},t=class extends w{constructor(){super(...arguments),this.size="1em",this.weight="regular",this.color="currentColor",this.mirrored=!1}render(){var a;return d`<svg
  ...
  `;o([l({type:String,reflect:!0})],t.prototype,"size",2);o([l({type:String,reflect:!0})],t.prototype,"weight",2);o([l({type:String,reflect:!0})],t.prototype,"color",2);o([l({type:Boolean,reflect:!0})],t.prototype,"mirrored",2);t=o([c("ph-arrow-clockwise")],t);export{t as PhArrowClockwise};
