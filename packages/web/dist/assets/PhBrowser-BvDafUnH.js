import{in as n,on as l,rn as p}from"./vendor-PMpPQw2V.js";import{n as g,r,t as c}from"./lit-element-BUMK4DaN.js";var d=Object.defineProperty,Z=Object.getOwnPropertyDescriptor,o=(a,s,H,i)=>{for(var e=i>1?void 0:i?Z(s,H):s,V=a.length-1,h;V>=0;V--)(h=a[V])&&(e=(i?h(s,H,e):h(e))||e);return i&&e&&d(s,H,e),e},t=class extends c{constructor(){super(...arguments),this.size="1em",this.weight="regular",this.color="currentColor",this.mirrored=!1}render(){var a;return g`<svg
  ...
  `;o([p({type:String,reflect:!0})],t.prototype,"size",2);o([p({type:String,reflect:!0})],t.prototype,"weight",2);o([p({type:String,reflect:!0})],t.prototype,"color",2);o([p({type:Boolean,reflect:!0})],t.prototype,"mirrored",2);t=o([n("ph-browser")],t);export{t as PhBrowser};
