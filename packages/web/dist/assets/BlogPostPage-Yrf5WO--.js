...
For more on this topic, see our articles on What is Sybil Detection and How Airdrop Farmers Get Caught.
    `}};function k(){const t=p[d().pathname.split("/").pop()||""];if((0,g.useEffect)(()=>{if(t){document.title=`${t.title} | FundTracer Blog`;const a=document.createElement("script");return a.type="application/ld+json",a.textContent=JSON.stringify({"@context":"https://schema.org","@type":"Article",headline:t.title,description:t.excerpt,author:{"@type":"Organization",name:t.author},datePublished:t.date,readTime:t.readTime,url:`https://www.fundtracer.xyz/blog/${t.slug}`}),document.head.appendChild(a),()=>{document.head.removeChild(a)}}},[t]),!t)return(0,e.jsx)(r,{navItems:o,showSearch:!1,children:(0,e.jsxs)("div",{className:"blog-post-error",children:[(0,e.jsx)("h1",{children:"Post Not Found"}),(0,e.jsx)("p",{children:"The blog post you're looking for doesn't exist."}),(0,e.jsx)("a",{href:"/blog",children:"Back to Blog"})]})});const l=t.content.split(`
