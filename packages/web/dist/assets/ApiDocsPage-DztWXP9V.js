import{o as b}from"./rolldown-runtime-MddlTo9B.js";import{Ar as f,Dn as d,Er as c,Fr as g,Hn as v,Kr as l,Lr as N,Or as A,Pr as C,Tr as T,Wr as o,gr as P,jr as h,lr as k,ou as R,wr as E,xu as I,yr as w}from"./vendor-PMpPQw2V.js";import{t as n}from"./proxy-Bbp7pKkD.js";import{t as _}from"./LandingLayout-bBC9H9cK.js";var x=b(I(),1),e=R(),z=[{label:"About",href:"/about"},{label:"Features",href:"/features"},{label:"Pricing",href:"/pricing"},{label:"How It Works",href:"/how-it-works"},{label:"FAQ",href:"/faq"},{label:"API",href:"/api-docs"},{label:"CLI",href:"/cli"}];function F(){const[m,r]=(0,x.useState)(null),[a,p]=(0,x.useState)("introduction"),j=(i,t)=>{navigator.clipboard.writeText(i),r(t),setTimeout(()=>r(null),2e3)},u=()=>{navigator.clipboard.writeText(`# FundTracer API Documentation
...
print(data['result'])`,"python-example")]}),(0,e.jsx)("h3",{children:"cURL"}),(0,e.jsxs)("div",{className:"api-code-block",children:[(0,e.jsx)("pre",{children:(0,e.jsx)("code",{children:`curl -X POST "https://api.fundtracer.xyz/api/analyze/wallet" \\
  ...
  -H "Content-Type: application/json" \\
  -H "Authorization: Bearer ft_live_YOUR_API_KEY" \\
  -d '{"address": "0x742d35Cc6634C0532925a3b844Bc9e7595f5b2a1", "chain": "ethereum"}'`,"curl-example")]})]}),(0,e.jsxs)("div",{className:"docs-cta",children:[(0,e.jsx)("h3",{children:"Ready to Start?"}),(0,e.jsx)("p",{children:"Get your API key and start building in minutes."}),(0,e.jsxs)("a",{href:"/api/keys",className:"cta-btn",children:["Get API Key",(0,e.jsx)(o,{size:18})]})]})]})]})]})})})}export{F as ApiDocsPage,F as default};
