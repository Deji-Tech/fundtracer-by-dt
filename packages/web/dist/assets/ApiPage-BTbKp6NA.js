import{o as _}from"./rolldown-runtime-MddlTo9B.js";import{Bn as A,Dn as k,Ir as P,On as S,Rn as F,Yl as B,br as T,gr as E,lr as I,pr as x,rr as O,uu as R,vr as r,wr as s}from"./vendor-D8za36Bz.js";import{t as j}from"./proxy-CcwnOhH9.js";import{t as D}from"./AnimatePresence-DQxyy4r7.js";import{t as Y}from"./LandingLayout-DBtUS1IC.js";var c=_(R(),1),e=B(),q=[{label:"About",href:"/about"},{label:"Features",href:"/features"},{label:"Pricing",href:"/pricing"},{label:"How It Works",href:"/how-it-works"},{label:"FAQ",href:"/faq"},{label:"API",href:"/api-docs",active:!0},{label:"CLI",href:"/cli"}];function W(){const[i,u]=(0,c.useState)(null),[l,g]=(0,c.useState)("overview"),[C,p]=(0,c.useState)(!1),[y,f]=(0,c.useState)(!1),[w,b]=(0,c.useState)(!1),[N,h]=(0,c.useState)(""),[t,v]=(0,c.useState)({name:"",company:"",email:"",message:""}),[K,L]=(0,c.useState)(!1),m=a=>{v(o=>({...o,[a.target.name]:a.target.value})),h("")},z=async a=>{if(a.preventDefault(),!t.name||!t.email||!t.message){h("Please fill in all required fields");return}f(!0),h("");try{const o=await(await fetch("/api/contact/sales",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(t)})).json();o.success?(b(!0),v({name:"",company:"",email:"",message:""})):h(o.error||"Failed to send message")}catch{h("Failed to send message. Please try again.")}finally{f(!1)}},n=(a,o)=>{navigator.clipboard.writeText(a),u(o),setTimeout(()=>u(null),2e3)},d={wallet:{curl:`curl -X POST "https://www.fundtracer.xyz/api/analyze/wallet" \\
...
data = response.json()`},fundingTree:{curl:`curl -X POST "https://www.fundtracer.xyz/api/analyze/funding-tree" \\
  -H "Content-Type: application/json" \\
  -H "Authorization: Bearer ft_live_YOUR_API_KEY" \\
...
data = response.json()`},compare:{curl:`curl -X POST "https://www.fundtracer.xyz/api/analyze/compare" \\
  -H "Content-Type: application/json" \\
  -H "Authorization: Bearer ft_live_YOUR_API_KEY" \\
