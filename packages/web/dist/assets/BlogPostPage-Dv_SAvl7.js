import{o as c}from"./rolldown-runtime-MddlTo9B.js";import{dc as d,vc as u,xc as h}from"./vendor-J89_OWP8.js";import{s as m}from"./primitives-DJkBfsnj.js";import{t as s}from"./LandingLayout-CRyQdOMF.js";var p=c(h(),1),e=d(),o=[{label:"Intel",href:"/"},{label:"Blog",href:"/blog",active:!0},{label:"Docs",href:"/docs/getting-started"},{label:"Features",href:"/features"},{label:"Pricing",href:"/pricing"},{label:"How It Works",href:"/how-it-works"},{label:"FAQ",href:"/faq"},{label:"API",href:"/api-docs"},{label:"CLI",href:"/cli"},{label:"About",href:"/about"}],y={"cli-rewards-command":{id:"cli-rewards",title:"Level Up with CLI: View Rewards from Terminal",excerpt:"Now track your leaderboard standing directly from the CLI.",category:"Product",date:"2026-04-28",readTime:"2 min read",author:"FundTracer Team",slug:"cli-rewards-command",content:`
...
`},"hackathon-starter-kit":{id:"hackathon-guide",title:"FundTracer Hackathon Starter Kit",excerpt:"Everything you need to build a winning hackathon project with FundTracer.",category:"Tutorial",date:"2026-04-28",readTime:"5 min read",author:"FundTracer Team",slug:"hackathon-starter-kit",content:`
## Build Fast, Win Big
...
Happy hacking! 🏆
`},"unified-solana-evm-ui":{id:"new",title:"Unified UI: App-Solana Now Matches App-EVM",excerpt:"We have completely redesigned our Solana analysis app to match the familiar EVM interface with shell-based navigation.",category:"Product",date:"2026-04-28",readTime:"3 min read",author:"FundTracer Team",slug:"unified-solana-evm-ui",content:`
...
For more on this topic, see our articles on What is Sybil Detection and How Airdrop Farmers Get Caught.
    `}};function k(){const t=y[u().pathname.split("/").pop()||""];if((0,p.useEffect)(()=>{if(t){document.title=`${t.title} | FundTracer Blog`;const a=document.createElement("script");return a.type="application/ld+json",a.textContent=JSON.stringify({"@context":"https://schema.org","@type":"Article",headline:t.title,description:t.excerpt,author:{"@type":"Organization",name:t.author},datePublished:t.date,readTime:t.readTime,url:`https://www.fundtracer.xyz/blog/${t.slug}`}),document.head.appendChild(a),()=>{document.head.removeChild(a)}}},[t]),!t)return(0,e.jsx)(s,{navItems:o,showSearch:!1,children:(0,e.jsxs)("div",{className:"blog-post-error",children:[(0,e.jsx)("h1",{children:"Post Not Found"}),(0,e.jsx)("p",{children:"The blog post you're looking for doesn't exist."}),(0,e.jsx)("a",{href:"/blog",children:"Back to Blog"})]})});const l=t.content.split(`

`).filter(a=>a.trim());return(0,e.jsx)(s,{navItems:o,showSearch:!1,children:(0,e.jsxs)("article",{className:"blog-post",children:[(0,e.jsxs)("header",{className:"blog-post__header",children:[(0,e.jsx)(m,{variant:"info",children:t.category}),(0,e.jsxs)("div",{className:"blog-post__meta",children:[(0,e.jsx)("span",{children:t.date}),(0,e.jsx)("span",{children:t.readTime})]})]}),(0,e.jsx)("h1",{className:"blog-post__title",children:t.title}),(0,e.jsx)("p",{className:"blog-post__excerpt",children:t.excerpt}),(0,e.jsx)("div",{className:"blog-post__content",children:l.map((a,i)=>a.startsWith("## ")?(0,e.jsx)("h2",{children:a.replace("## ","")},i):a.startsWith("### ")?(0,e.jsx)("h3",{children:a.replace("### ","")},i):a.startsWith("- ")?(0,e.jsx)("ul",{children:a.split(`
`).filter(n=>n.startsWith("- ")).map((n,r)=>(0,e.jsx)("li",{children:n.replace("- ","")},r))},i):/^\d+\./.test(a)?(0,e.jsx)("ol",{children:a.split(`
`).filter(n=>/^\d+\./.test(n)).map((n,r)=>(0,e.jsx)("li",{children:n.replace(/^\d+\.\s*/,"")},r))},i):(0,e.jsx)("p",{children:a},i))}),(0,e.jsx)("footer",{className:"blog-post__footer",children:(0,e.jsx)("a",{href:"/blog",className:"blog-post__back",children:"Back to Blog"})})]})})}export{k as BlogPostPage,k as default};
