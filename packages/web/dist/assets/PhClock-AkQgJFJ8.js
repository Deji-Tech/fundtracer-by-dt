import{in as g,on as c,rn as h}from"./vendor-DHU1kG0o.js";import{n as m,r,t as Z}from"./lit-element-DBDtvLpp.js";var d=Object.defineProperty,A=Object.getOwnPropertyDescriptor,o=(a,s,p,i)=>{for(var e=i>1?void 0:i?A(s,p):s,l=a.length-1,n;l>=0;l--)(n=a[l])&&(e=(i?n(s,p,e):n(e))||e);return i&&e&&d(s,p,e),e},t=class extends Z{constructor(){super(...arguments),this.size="1em",this.weight="regular",this.color="currentColor",this.mirrored=!1}render(){var a;return m`<svg
  ...
  `;o([h({type:String,reflect:!0})],t.prototype,"size",2);o([h({type:String,reflect:!0})],t.prototype,"weight",2);o([h({type:String,reflect:!0})],t.prototype,"color",2);o([h({type:Boolean,reflect:!0})],t.prototype,"mirrored",2);t=o([g("ph-clock")],t);export{t as PhClock};
