import{o as A}from"./rolldown-runtime-MddlTo9B.js";import{Ar as w,Dn as k,Er as P,Hn as S,On as F,Or as r,Pr as s,Sr as x,Wn as T,gr as B,lr as E,ou as O,qr as I,xu as D}from"./vendor-PMpPQw2V.js";import{t as j}from"./proxy-Bbp7pKkD.js";import{t as R}from"./AnimatePresence-MOlCFjyM.js";import{t as Y}from"./LandingLayout-bBC9H9cK.js";import{t as q}from"./navigation-BjAQwCbH.js";var c=A(D(),1),e=O(),K=q.map(i=>i.href==="/api-docs"?{...i,active:!0}:i);function V(){const[i,u]=(0,c.useState)(null),[l,g]=(0,c.useState)("overview"),[C,p]=(0,c.useState)(!1),[y,f]=(0,c.useState)(!1),[z,N]=(0,c.useState)(!1),[b,h]=(0,c.useState)(""),[t,v]=(0,c.useState)({name:"",company:"",email:"",message:""}),[L,U]=(0,c.useState)(!1),m=a=>{v(o=>({...o,[a.target.name]:a.target.value})),h("")},_=async a=>{if(a.preventDefault(),!t.name||!t.email||!t.message){h("Please fill in all required fields");return}f(!0),h("");try{const o=await(await fetch("/api/contact/sales",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(t)})).json();o.success?(N(!0),v({name:"",company:"",email:"",message:""})):h(o.error||"Failed to send message")}catch{h("Failed to send message. Please try again.")}finally{f(!1)}},n=(a,o)=>{navigator.clipboard.writeText(a),u(o),setTimeout(()=>u(null),2e3)},d={wallet:{curl:`curl -X POST "https://api.fundtracer.xyz/api/analyze/wallet" \\
