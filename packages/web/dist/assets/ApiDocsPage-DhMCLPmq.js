import{o as b}from"./rolldown-runtime-MddlTo9B.js";import{Dn as d,Dr as f,Fr as c,Nr as l,Rn as g,Tr as v,Yl as N,br as w,gr as o,hr as A,lr as C,mr as T,rr as R,ur as k,uu as P,vr as E,wr as I,xr as h}from"./vendor-D8za36Bz.js";import{t as n}from"./proxy-CcwnOhH9.js";import{t as _}from"./LandingLayout-DBtUS1IC.js";var x=b(P(),1),e=N(),z=[{label:"About",href:"/about"},{label:"Features",href:"/features"},{label:"Pricing",href:"/pricing"},{label:"How It Works",href:"/how-it-works"},{label:"FAQ",href:"/faq"},{label:"API",href:"/api-docs"},{label:"CLI",href:"/cli"}];function O(){const[m,r]=(0,x.useState)(null),[a,p]=(0,x.useState)("introduction"),j=(i,t)=>{navigator.clipboard.writeText(i),r(t),setTimeout(()=>r(null),2e3)},u=()=>{navigator.clipboard.writeText(`# FundTracer API Documentation
...
data = response.json()
print(data['result'])`,"python-example")]}),(0,e.jsx)("h3",{children:"cURL"}),(0,e.jsxs)("div",{className:"api-code-block",children:[(0,e.jsx)("pre",{children:(0,e.jsx)("code",{children:`curl -X POST "https://www.fundtracer.xyz/api/analyze/wallet" \\
  -H "Content-Type: application/json" \\
  -H "Authorization: Bearer ft_live_YOUR_API_KEY" \\
  -d '{"address": "0x742d35Cc6634C0532925a3b844Bc9e7595f5b2a1", "chain": "ethereum"}'`})}),s(`curl -X POST "https://www.fundtracer.xyz/api/analyze/wallet" \\
  -H "Content-Type: application/json" \\
  -H "Authorization: Bearer ft_live_YOUR_API_KEY" \\
  -d '{"address": "0x742d35Cc6634C0532925a3b844Bc9e7595f5b2a1", "chain": "ethereum"}'`,"curl-example")]})]}),(0,e.jsxs)("div",{className:"docs-cta",children:[(0,e.jsx)("h3",{children:"Ready to Start?"}),(0,e.jsx)("p",{children:"Get your API key and start building in minutes."}),(0,e.jsxs)("a",{href:"/api/keys",className:"cta-btn",children:["Get API Key",(0,e.jsx)(l,{size:18})]})]})]})]})]})})})}export{O as ApiDocsPage,O as default};
