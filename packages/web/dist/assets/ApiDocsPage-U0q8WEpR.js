import{o as b}from"./rolldown-runtime-MddlTo9B.js";import{An as c,Cn as f,Mn as l,Ot as g,Tc as v,Yt as N,_n as o,an as A,bn as C,dn as T,fn as h,gn as k,hc as P,mn as R,mt as d,nn as E,un as I,xn as w}from"./vendor-ZFsBW_sc.js";import{t as n}from"./proxy-DXb4yVD7.js";import{t as _}from"./LandingLayout-jU2Yr3Qa.js";var x=b(v(),1),e=P(),z=[{label:"About",href:"/about"},{label:"Features",href:"/features"},{label:"Pricing",href:"/pricing"},{label:"How It Works",href:"/how-it-works"},{label:"FAQ",href:"/faq"},{label:"API",href:"/api-docs"},{label:"CLI",href:"/cli"}];function q(){const[m,r]=(0,x.useState)(null),[a,p]=(0,x.useState)("introduction"),j=(i,t)=>{navigator.clipboard.writeText(i),r(t),setTimeout(()=>r(null),2e3)},u=()=>{navigator.clipboard.writeText(`# FundTracer API Documentation
