import{in as g,on as d,rn as i}from"./vendor-PMpPQw2V.js";import{n as c,r,t as u}from"./lit-element-BUMK4DaN.js";var w=Object.defineProperty,y=Object.getOwnPropertyDescriptor,o=(a,s,p,l)=>{for(var e=l>1?void 0:l?y(s,p):s,h=a.length-1,n;h>=0;h--)(n=a[h])&&(e=(l?n(s,p,e):n(e))||e);return l&&e&&w(s,p,e),e},t=class extends u{constructor(){super(...arguments),this.size="1em",this.weight="regular",this.color="currentColor",this.mirrored=!1}render(){var a;return c`<svg
  ...
  `;o([i({type:String,reflect:!0})],t.prototype,"size",2);o([i({type:String,reflect:!0})],t.prototype,"weight",2);o([i({type:String,reflect:!0})],t.prototype,"color",2);o([i({type:Boolean,reflect:!0})],t.prototype,"mirrored",2);t=o([g("ph-caret-up")],t);export{t as PhCaretUp};
